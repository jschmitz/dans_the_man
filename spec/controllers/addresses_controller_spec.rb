...
describe AddressesController do
  ...
  let(:valid_attributes) { { "street_address" => "MyString" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested address" do
        ...
        Address.any_instance.should_receive(:update).with({ "street_address" => "MyString" })
        put :update, {:id => address.to_param, :address => { "street_address" => "MyString" }}, valid_session
      end
