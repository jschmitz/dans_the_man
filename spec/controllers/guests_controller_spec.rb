  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved guest as @guest" do
        ...
        post :create, {:guest => { "address_id" => "invalid value" }}, valid_session
        assigns(:guest).should be_a_new(Guest)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested guest" do
        ...
        Guest.any_instance.should_receive(:update).with({ "address_id" => "1" })
        put :update, {:id => guest.to_param, :guest => { "address_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the guest as @guest" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Guest.any_instance.stub(:save).and_return(false)
        put :update, {:id => guest.to_param, :guest => { "address_id" => "invalid value" }}, valid_session
        assigns(:guest).should eq(guest)
      end
